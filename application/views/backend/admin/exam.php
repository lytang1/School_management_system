                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/exam/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                   <select name="exam_type" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="subject" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                        <option value="">Select</option>
                                        <?php $subjects = $this->db->get('subject')->result_array();
                                        foreach ($subjects as $subject_row):?>
                                        <option value="<?php echo $subject_row['subject_id'];?>"> <?php echo ucfirst($subject_row['name']);?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
