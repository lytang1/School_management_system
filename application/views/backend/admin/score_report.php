<div>
	<br><br>
    <?php echo form_open(base_url().'index.php?admin/report_subscore/view', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
    <section class=' row'>
  ...
  <section class='row'>
        ...
        <section class='col-sm-8'>
       <select name="subject" class="form-control" id="subject" data-validate="required" data-message-required="<?php echo 'Required ';?>">
                <option value="">Select</option>
                <?php foreach ($subjects as $sub_row):?>
                    <option value="<?php echo $sub_row['subject_id'];?>"  class="<?php echo $sub_row['c_id'];?> hide"><?php echo $sub_row['name'];?></option>
                <?php endforeach;?>
        </select>
        </section>
    </section>
