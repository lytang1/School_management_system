...
`invoice_id` int(11) NOT NULL ,
  ...
  `status` longtext COLLATE utf8_unicode_ci NOT NULL COMMENT 'paid or unpaid or partial'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
`parent_id` int(11) NOT NULL,
  `father_name` longtext COLLATE utf8_unicode_ci,
  `father_phone` longtext COLLATE utf8_unicode_ci,
  `mother_name` longtext COLLATE utf8_unicode_ci,
  `mother_phone` longtext COLLATE utf8_unicode_ci
...
`student_id` int(11) NOT NULL,
  ...
  `emergency_contact_name` longtext COLLATE utf8_unicode_ci NOT NULL,
  `emergency_contact_number` longtext COLLATE utf8_unicode_ci NOT NULL,
  `class_id` longtext COLLATE utf8_unicode_ci NOT NULL,
  `parent_id` int(11) NOT NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
